...
<body>
		<div class="navbar text-neutral-content bg-white">
				<a href="#">
						<img style="width: 160px; height: 55px;" src="/resource/img/DEMYS.jpg" alt="" />
				</a>
				...
				<div class="flex-none">
						<div class="dropdown dropdown-end">
								...
								<ul tabindex="0" class="flex menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52"
										style="color:black; width:500px; height:400px; align-items:center;">
										<span class="text-center" style="width:480px; height:40px; border-radius:10px; background-color:red; line-height:40px;">Notification</span>
										<li style="width:450px; border-bottom:1px solid black;">
												<div class="alramBoard m-2" style="border-radius:5px;">
